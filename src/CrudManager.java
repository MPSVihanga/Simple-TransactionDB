...
public class CrudManager {
    ...
    public boolean saveData(Account account, Payment payment) throws SQLException, ClassNotFoundException {
        ...
        try {
            ...
            preparedStatement1.setString(1, account.getAccId());
            ...
            if (isSaved) {
                ...
                preparedStatement2.setString(4, account.getAccId());
                if (preparedStatement2.executeUpdate() > 0){
                    connection.commit();
                    return true;
                }
                connection.rollback(); // server ekt data send wu,save wunu nethi data delete krla dnwa
            }
            return false;
